...
import type { PomodoroSession as _PomodoroSession, SoundProfile as _SoundProfile, Streak as _Streak, Theme as _Theme, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getSessions(): Promise<Array<PomodoroSession>> {
        if (this.processError) {
            try {
    ...
    async saveSession(arg0: string, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSession(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSoundProfile(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSoundProfile(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTheme(arg0: Theme): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTheme(to_candid_Theme_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    theme: _Theme;
    streak: _Streak;
    sessions: Array<_PomodoroSession>;
    totalPomodoros: bigint;
    totalFocusTime: bigint;
}): {
    soundProfile: SoundProfile;
    ...
    return {
        ...
        totalPomodoros: value.totalPomodoros,
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "lavenderDream" in value ? Theme.lavenderDream : "sunnyCitrus" in value ? Theme.sunnyCitrus : "cherryBlossom" in value ? Theme.cherryBlossom : "mintGarden" in value ? Theme.mintGarden : "midnightStars" in value ? Theme.midnightStars : value;
}
...
function to_candid_Theme_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Theme): _Theme {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        soundProfile: value.soundProfile,
        theme: to_candid_Theme_n12(_uploadFile, _downloadFile, value.theme),
        streak: value.streak,
        sessions: value.sessions,
        totalPomodoros: value.totalPomodoros,
        totalFocusTime: value.totalFocusTime
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Theme): {
    lavenderDream: null;
} | {
    sunnyCitrus: null;
} | {
    ...
    return value == Theme.lavenderDream ? {
        lavenderDream: null
    } : value == Theme.sunnyCitrus ? {
        sunnyCitrus: null
    } : value == Theme.cherryBlossom ? {
        cherryBlossom: null
    } : value == Theme.mintGarden ? {
        mintGarden: null
    } : value == Theme.midnightStars ? {
        midnightStars: null
    } : value;
}
